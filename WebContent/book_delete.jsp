...
<div class=content>
			<div class=right>
				<div class=right_box>
					<div class=info_bk1>
						<div align="center">
							<form action="book_delete.action" method="post" >
								<br><br><br><br><br><br><br><br>
								书&nbsp;&nbsp;号:
								<input type="text" id="name" name="book.bookid" size=20
									onblur="validate()" />
								<br><br><br>
								<input style= "color:#FFFFFF;background-color:#009393;font-size:16px;width:220px" type="submit" value="删除">
								<br><br>
							</form>
						</div>
					</div>
