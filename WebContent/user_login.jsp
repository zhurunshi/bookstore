					...
					<div class=info_bk1>
						<div align="center">
							...
							<br><br><br>
								...
								<a href="cart_show.jsp"></a><input style= "color:#FFFFFF;background-color:#009393;font-size:16px;width:220px" type="submit" value="登录">
								</s:if>	
								<s:else>
									<input style= "color:#FFFFFF;background-color:#009393;font-size:16px;width:220px" type="submit" value="登录">
								</s:else>	
								<br>
								<p><a href="user_register.jsp" style="text-decoration:none">立即注册</a></p>
								</div>
							</form>
						</div>
					</div>
