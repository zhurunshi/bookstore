...
<div class=content>
			<div class=right>
				<div class=right_box>
					<div class=info_bk1>
						<div align="center">
							<form action="book_add.action" method="post" >
								<br><br><br><br><br>
								书&nbsp;&nbsp;名:
								...
								<br><br><br>
								图&nbsp;&nbsp;片:
								<input type="text" name="book.picture" size=20>
								<br><br><br>
								<input style= "color:#FFFFFF;background-color:#009393;font-size:16px;width:220px" type="submit" value="添加">
							<br><br>
							</form>
						</div>
					</div>
